...
parser.add_argument('--exp_name', type=str, default='gnn_debug_vx', metavar='N',
...
parser.add_argument('--dataset_root', type=str, default='dataset', metavar='N',
                    help='Root dataset')
...
io = IOStream('output/' + args.exp_name + '/run.log')
io.cprint(str(args))
...
def adjust_learning_rate(optimizers, lr, iteration):
    new_lr = lr * (0.5**(int(iteration/args.dec_lr)))
